...
def arguments():
    ...
    parser.add_argument("-m", "--model", default="facebook/mbart-large-50-many-to-many-mmt", help="Folder containing a mBart model.")
    ...
    #parser.add_argument("-l", "--lang", default="pt_XX", help="Language code that should be used in the tokenizer. For instance, 'pt_XX' for Portuguese and 'en_XX' for English.")
    parser.add_argument("-l", "--lang", default="sq", help="Language code that should be used in the tokenizer. For instance, 'pt_XX' for Portuguese and 'en_XX' for English.")
