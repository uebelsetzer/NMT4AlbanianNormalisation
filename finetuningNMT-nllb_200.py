...
from transformers import AutoModelForSeq2SeqLM, DataCollatorForSeq2Seq, Seq2SeqTrainingArguments, Seq2SeqTrainer, NllbTokenizer, EarlyStoppingCallback


def arguments():
    parser = argparse.ArgumentParser(description="Fine-tune NMT models")
    parser.add_argument("-m", "--model", default="facebook/nllb-200-distilled-600M", help="Folder path: path to model that is going to be fine-tuned.")
