...
from transformers import AutoModelForSeq2SeqLM, DataCollatorForSeq2Seq, Seq2SeqTrainingArguments, Seq2SeqTrainer, MBart50TokenizerFast, EarlyStoppingCallback


def arguments():
    parser = argparse.ArgumentParser(description="Fine-tune NMT models")
    #parser.add_argument("-m", "--model", default="Helsinki-NLP/opus-mt-tc-big-itc-itc", help="Folder path: path to MarianMT model that is going to be fine-tuned.")
